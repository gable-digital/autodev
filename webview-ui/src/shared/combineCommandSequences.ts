...
/**
 * Combines sequences of command and command_output messages in an array of AutoDevMessages.
 *
 * This function processes an array of AutoDevMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of AutoDevMessage objects to process.
 * @returns A new array of AutoDevMessage objects with command sequences combined.
 *
 * @example
 * const messages: AutoDevMessage[] = [
 ...
 */
export function combineCommandSequences(messages: AutoDevMessage[]): AutoDevMessage[] {
	const combinedCommands: AutoDevMessage[] = []
