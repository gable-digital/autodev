...
import { AutoDevCheckpointRestore } from "../../../../src/shared/WebviewMessage"
...
export const CheckpointOverlay = ({ messageTs }: CheckpointOverlayProps) => {
	...
	const handleRestoreTask = () => {
		...
		vscode.postMessage({
			...
			number: messageTs,
			text: "task" satisfies AutoDevCheckpointRestore,
		})
	}
	...
	const handleRestoreWorkspace = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "workspace" satisfies AutoDevCheckpointRestore,
		})
	}
	...
	const handleRestoreBoth = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "taskAndWorkspace" satisfies AutoDevCheckpointRestore,
		})
	}
