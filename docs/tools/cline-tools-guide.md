# AutoDev Tools Reference Guide

## What Can AutoDev Do?

AutoDev is your AI assistant that can:
...
3. **Review Changes**
    - AutoDev will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [AutoDev repository](https://github.com/autodev/autodev/blob/main/src/core/AutoDev.ts).

AutoDev has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that AutoDev can then access
    - Example: Create a weather API tool that AutoDev can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/autodev)
-   Check the documentation
-   Provide feedback to improve AutoDev
