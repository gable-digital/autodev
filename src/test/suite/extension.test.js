...
describe("Extension Tests", function () {
	...
	it("should activate extension successfully", async () => {
		// Get the extension
		const extension = vscode.extensions.getExtension("gable-digital-solutions.gds-autodev")
	...
	it("should open sidebar view", async () => {
		...
		await vscode.commands.executeCommand("autodev.plusButtonClicked")
	...
	it("should handle basic commands", async () => {
		...
		await vscode.commands.executeCommand("autodev.historyButtonClicked")
