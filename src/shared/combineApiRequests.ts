...
/**
 * Combines API request start and finish messages in an array of AutoDevMessages.
 *
 ...
 * @returns A new array of AutoDevMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: AutoDevMessage[]): AutoDevMessage[] {
	const combinedApiRequests: AutoDevMessage[] = []
